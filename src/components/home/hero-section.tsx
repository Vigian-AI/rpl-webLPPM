...
export function HeroSection() {
  return (
    <section className="relative bg-gradient-to-br from-[#03045E] via-[#03045E] to-[#020338] text-white overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              ...
              DAN PENGABDIAN<br />
              MASYARAKAT{' '}
              <span className="text-[#F59E0B]">(LPPM)</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 text-sm">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#F59E0B] flex items-center justify-center">
                  <Globe className="h-4 w-4 text-[#03045E]" />
                </div>
                <span>lppm.upb.ac.id</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#F59E0B] flex items-center justify-center">
                  <Phone className="h-4 w-4 text-[#03045E]" />
                </div>
                <span>0877-3274-6000</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#F59E0B] flex items-center justify-center">
                  <Mail className="h-4 w-4 text-[#03045E]" />
                </div>
          ...
          <div className="relative flex justify-center md:justify-end">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 w-full h-full rounded-full bg-[#F59E0B]/30"></div>
              
              {/* Main image container */}
              <div className="relative w-72 h-72 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-[#F59E0B] shadow-2xl bg-[#03045E]">
                <Image
                  src="/gedung.jpeg"
