...
export default function DosenUndanganPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Kelola undangan bergabung tim penelitian dari dosen lain</p>
      </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Undangan dari dosen lain akan muncul di sini
            </p>
          </CardContent>
        </Card>
      ) : (
